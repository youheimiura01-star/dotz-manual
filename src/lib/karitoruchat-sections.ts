...
<a class="scene-card scene-link" data-tab="case-studies" data-heading="0">
  ...
  <div class="scene-description">400社超の運用実績。洋服の青山で売上4倍、ロート製薬でLTV2倍の実績。</div>
...
400社以上の運用実績があり、洋服の青山様ではLINE経由売上が<strong>4倍</strong>になった実績もあります。」
</div>
...
<tr><td>400社超の運用実績</td><td>豊富なデータに基づく最適な施策提案。業種別のノウハウが蓄積</td></tr>
...
本日は、EC事業者様の<strong>広告CPAを下げながらCVを増やす方法</strong>について
1分だけお時間いただきたくお電話しました。
...
<tr><td>「忙しい」「時間ない」</td><td>「15秒だけ。ECサイトの離脱者をLINEでCVに変えるサービスです。成果報酬で費用リスクゼロ、400社実績。資料だけお送りしてもいいですか？」→ <strong>プロット4へ</strong></td></tr>
...
LINEへの誘導バナーを表示し、LINE登録後にチャットボットとプッシュ配信で
自動的にCVまで導くというものです。
...
<strong>③ 400社超の実績</strong> — 洋服の青山様でLINE経由売上<strong>4倍</strong>、ロート製薬様でLTV<strong>2倍</strong>。
...
<strong>3つ目は、400社以上の運用実績があること。</strong>
...
また、400社超の運用データに基づく最適化ノウハウがあります。
...
こうした実績が出せるのは、400社以上の運用データに基づいて最適なシナリオを構築しているからです。
...
<li>診断型チャットボットで顧客の肌タイプに合った商品を自動提案</li>
...
<tr><td>課題</td><td>デジタルマーケティングの立ち上げ、顧客接点の構築</td></tr>
<tr><td>施策</td><td>ゼロからのLINE公式アカウント立ち上げ → チャットボット + プッシュ配信</td></tr>
